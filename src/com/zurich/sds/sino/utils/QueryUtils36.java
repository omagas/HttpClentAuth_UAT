...
public class QueryUtils36 {
    ...
    /**
     * insert / update / delete / call Stored Procedure ä½¿ç?
     * @param sql
     * @param params
     * @throws SQLException
     */
    ...
    /**
     * å¤?¬¡??insert / update / delete / call Stored Procedure, ????ºä???Transaction
     * @param batchSQL
     * @throws SQLException
     */
    ...
    /**
     * å°?java.util.Date è½?? java.sql.Date, ?¦å??²å? DBUtils ??????
     * @param params
     */
    ...
    /**
     * ??? Connection,
     * TODO : å¦?? batch ?¼å?, ????¹å¯«??keep ?®ä? Connection å°±å¥½, ä¸????? get/closeConnection
     * @return
     * @throws SQLException
     */
...
//        }
//        return conn4Query;
        return ConnectionFactory4Properties36.getInstance().getConnection();
    }
    ...
    private void closeConnection(Connection conn) {
        ConnectionFactory4Properties36.getInstance().releaseConnection(conn);
    }
}
